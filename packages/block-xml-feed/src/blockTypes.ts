...
export const BLOCK_TYPE_OPTIONS = [
  ...
  { value: 'TherapeuticUpdateXml', label: 'Therapeutic Update XML', blockTitle: 'Therapeutic Updates', path: '/therapeutic-update-xml' },
  { value: 'FeaturedStoryXml', label: 'Large Story Block', blockTitle: 'Featured Story', path: '/featured-story-xml' },
  { value: 'NewsPanelXml', label: 'News Panel XML', blockTitle: 'News Panel', path: '/daily-news-xml' },
  { value: 'BlogXml', label: 'Blog XML', blockTitle: 'Blogs', path: '/blogs-xml' },
  { value: 'Advertisement72890Xml', label: 'Advertisement 728x90 XML', blockTitle: 'Advertisement 728x90', path: '/admin/email_ad_728_90_xml' },
  { value: 'Advertisement300250Xml', label: 'Advertisement 300x250 XML', blockTitle: 'Advertisement 300x250', path: '/email_ad_300_250_xml' },
  { value: 'ConferenceAdvertisement300250Xml', label: 'Conference Advertisement 300x250 XML', blockTitle: 'Conference Advertisement', path: '/conference-email-ad-300-250-xml' },
