...
function parseTherapeuticUpdateXml(xmlText, numberOfItems) {
    try {
...
export function TherapeuticUpdateXml({ style, props }) {
    var _a, _b, _c;
    const url = (_a = props === null || props === void 0 ? void 0 : props.url) !== null && _a !== void 0 ? _a : TherapeuticUpdateXmlPropsDefaults.url;
    const title = (_b = props === null || props === void 0 ? void 0 : props.title) !== null && _b !== void 0 ? _b : TherapeuticUpdateXmlPropsDefaults.title;
    const numberOfItems = (_c = props === null || props === void 0 ? void 0 : props.numberOfItems) !== null && _c !== void 0 ? _c : TherapeuticUpdateXmlPropsDefaults.numberOfItems;
    ...
    if (!url) {
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { border: '1px dashed #ccc', textAlign: 'center', padding: '20px' }) }, "Configure Therapeutic Update XML URL");
    }
    if (loading)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { textAlign: 'center', padding: '20px' }) }, "Loading updates...");
    if (error)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { color: 'red', textAlign: 'center', padding: '20px' }) },
            "Error: ",
            error);
    if (items.length === 0)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { textAlign: 'center', padding: '20px' }) }, "No updates found.");
    return (React.createElement("div", { style: wrapperStyle },
        ...
        items.map((item, index) => (React.createElement("div", { key: index, style: { marginBottom: 24, paddingBottom: 16, borderBottom: index < items.length - 1 ? '1px solid #eee' : 'none' } },
            ...
            React.createElement("div", { style: { fontSize: '12px', color: '#666', marginBottom: '8px' } },
                item.showAuthor && item.authorAttribution && (React.createElement("div", null,
                    React.createElement("span", { style: { color: item.isSponsored ? '#800080' : 'inherit', fontWeight: item.isSponsored ? 'bold' : 'normal' } }, item.authorAttribution))),
