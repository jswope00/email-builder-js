...
import { FeaturedStoryXmlPropsDefaults, FeaturedStoryXmlPropsSchema } from '@usewaypoint/block-featured-story-xml';
import BaseSidebarPanel from './helpers/BaseSidebarPanel';
import TextInput from './helpers/inputs/TextInput';
import MultiStylePropertyPanel from './helpers/style-inputs/MultiStylePropertyPanel';
export default function FeaturedStoryXmlSidebarPanel({ data, setData }) {
    ...
    const url = (_b = (_a = data.props) === null || _a === void 0 ? void 0 : _a.url) !== null && _b !== void 0 ? _b : FeaturedStoryXmlPropsDefaults.url;
    const title = (_d = (_c = data.props) === null || _c === void 0 ? void 0 : _c.title) !== null && _d !== void 0 ? _d : FeaturedStoryXmlPropsDefaults.title;
    const numberOfItems = (_f = (_e = data.props) === null || _e === void 0 ? void 0 : _e.numberOfItems) !== null && _f !== void 0 ? _f : FeaturedStoryXmlPropsDefaults.numberOfItems;
    return (React.createElement(BaseSidebarPanel, { title: "Featured Story XML Block" },
...
//# sourceMappingURL=FeaturedStoryXmlSidebarPanel.js.map