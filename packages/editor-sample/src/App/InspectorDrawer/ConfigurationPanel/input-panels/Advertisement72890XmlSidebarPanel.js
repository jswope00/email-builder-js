...
import { Advertisement72890XmlPropsDefaults, Advertisement72890XmlPropsSchema } from '@usewaypoint/block-advertisement-728-90-xml';
import BaseSidebarPanel from './helpers/BaseSidebarPanel';
import TextInput from './helpers/inputs/TextInput';
import MultiStylePropertyPanel from './helpers/style-inputs/MultiStylePropertyPanel';
export default function Advertisement72890XmlSidebarPanel({ data, setData }) {
    ...
    const url = (_b = (_a = data.props) === null || _a === void 0 ? void 0 : _a.url) !== null && _b !== void 0 ? _b : Advertisement72890XmlPropsDefaults.url;
    const title = (_d = (_c = data.props) === null || _c === void 0 ? void 0 : _c.title) !== null && _d !== void 0 ? _d : Advertisement72890XmlPropsDefaults.title;
    const numberOfItems = (_f = (_e = data.props) === null || _e === void 0 ? void 0 : _e.numberOfItems) !== null && _f !== void 0 ? _f : Advertisement72890XmlPropsDefaults.numberOfItems;
    return (React.createElement(BaseSidebarPanel, { title: "Advertisement 728x90 XML Block" },
...
//# sourceMappingURL=Advertisement72890XmlSidebarPanel.js.map