...
import { z } from 'zod';
export declare const VideoXmlPropsSchema: z.ZodObject<{
...
export declare const VideoXmlPropsDefaults: {
    readonly url: "";
    readonly title: "";
    readonly numberOfItems: 3;
};
export declare function VideoXml({ style, props }: VideoXmlProps): React.JSX.Element;
