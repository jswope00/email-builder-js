...
const PlayIcon = () => (React.createElement("div", { style: {
        position: 'absolute',
        top: '50%',
        left: '50%',
...
function parseFeaturedStoryXml(xmlText, numberOfItems) {
    try {
...
export function FeaturedStoryXml({ style, props }) {
    var _a, _b, _c;
    const url = (_a = props === null || props === void 0 ? void 0 : props.url) !== null && _a !== void 0 ? _a : FeaturedStoryXmlPropsDefaults.url;
    const title = (_b = props === null || props === void 0 ? void 0 : props.title) !== null && _b !== void 0 ? _b : FeaturedStoryXmlPropsDefaults.title;
    const numberOfItems = (_c = props === null || props === void 0 ? void 0 : props.numberOfItems) !== null && _c !== void 0 ? _c : FeaturedStoryXmlPropsDefaults.numberOfItems;
    ...
    if (!url) {
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { border: '1px dashed #ccc', textAlign: 'center', padding: '20px' }) }, "Configure Featured Story XML URL");
    }
    if (loading)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { textAlign: 'center', padding: '20px' }) }, "Loading stories...");
    if (error)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { color: 'red', textAlign: 'center', padding: '20px' }) },
            "Error: ",
            error);
    if (items.length === 0)
        return React.createElement("div", { style: Object.assign(Object.assign({}, wrapperStyle), { textAlign: 'center', padding: '20px' }) }, "No stories found.");
    ...
    return (React.createElement("div", { style: wrapperStyle },
        ...
        items.map((item, index) => (React.createElement("div", { key: index, style: { marginBottom: 24, paddingBottom: 16, borderBottom: index < items.length - 1 ? '1px solid #eee' : 'none' } },
            ...
            React.createElement("div", { style: { fontSize: '12px', color: '#666', marginBottom: '8px' } },
                item.showAuthor && item.authorAttribution && (React.createElement(React.Fragment, null,
                    React.createElement("span", { style: { fontWeight: 'bold' } }, item.authorAttribution),
            ...
            item.viewNode ? (React.createElement("a", { href: item.viewNode, target: "_blank", style: { textDecoration: 'none', color: 'inherit', display: 'block' } }, item.image && (React.createElement("div", { style: { position: 'relative', marginBottom: 12 } },
                ...
                isVideoType(item.type) && React.createElement(PlayIcon, null))))) : (React.createElement(React.Fragment, null, item.image && (React.createElement("div", { style: { position: 'relative', marginBottom: 12 } },
                React.createElement("img", { src: item.image, alt: item.title, style: { width: '100%', maxWidth: '100%', height: 'auto', display: 'block', borderRadius: 4 } }),
                isVideoType(item.type) && React.createElement(PlayIcon, null))))),
            item.body && (React.createElement("div", { style: { fontSize: '14px', lineHeight: '1.5', color: '#666' } }, item.body.replace(/<!\[CDATA\[|\]\]>/g, ''))))))));
}
